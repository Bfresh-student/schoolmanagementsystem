...
const HRAPI = {
    ...
    candidateDocuments(candidateId) { return apiClientRequest(`/hr/candidate-documents/?candidate=${encodeURIComponent(candidateId)}`); },
    createCandidateDocument(formData) { return apiFetchMultipart('/hr/candidate-documents/', formData); },
    deleteCandidateDocument(id) { return apiClientRequest(`/hr/candidate-documents/${id}/`, { method: 'DELETE' }); },
