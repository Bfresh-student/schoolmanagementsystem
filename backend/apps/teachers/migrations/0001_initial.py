    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_synced",
                    models.BooleanField(
                        db_index=True, default=False, verbose_name="Synchronisé"
                    ),
                ),
                (
                    "synced_at",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Nombre de tentatives de sync"
                    ),
                ),
                (
                    "last_sync_error",
                    models.TextField(
                        blank=True, verbose_name="Dernière erreur de sync"
                    ),
                ),
                (
                    "rating",
                ...
                (
                    "teacher_id",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="ID Professeur"
                    ),
                ),
                (
                    "employment_type",
                ...
                (
                    "salary_grade",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Échelon salarial"
                    ),
                ),
                (
                    "monthly_salary",
                ...
                (
                    "office_location",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Bureau/Salle"
                    ),
                ),
                (
                    "office_phone",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="Téléphone bureau"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_present",
                    models.BooleanField(default=True, verbose_name="Présent"),
                ),
                (
                    "check_in_time",
                    models.TimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=300, verbose_name="Nom de la certification"
                    ),
                ),
                (
                    "issuing_body",
                    models.CharField(max_length=300, verbose_name="Organisme émetteur"),
                ),
                ...
                (
                    "credential_id",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="ID d'accréditation"
                    ),
                ),
                (
                    "credential_url",
                    models.URLField(blank=True, verbose_name="URL de la accréditation"),
                ),
                (
                    "created_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "teaching_quality",
                    models.IntegerField(
                        default=3, verbose_name="Qualité d'enseignement"
                    ),
                ),
                (
                    "student_engagement",
                    models.IntegerField(
                        default=3, verbose_name="Engagement des élèves"
                    ),
                ),
                (
                    "professionalism",
                    models.IntegerField(default=3, verbose_name="Professionnalisme"),
                ),
                (
                    "communication",
                    models.IntegerField(default=3, verbose_name="Communication"),
                ),
                (
                    "class_management",
                    models.IntegerField(default=3, verbose_name="Gestion de classe"),
                ),
                (
                    "overall_rating",
                    models.DecimalField(
                ...
                (
                    "improvement_areas",
                    models.TextField(
                        blank=True, verbose_name="Domaines d'amélioration"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "graduation_year",
                    models.IntegerField(verbose_name="Année de graduation"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Salle/Bureau"
                    ),
                ),
                (
                    "activity",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subject",
                    models.CharField(max_length=200, verbose_name="Matière/Sujet"),
                ),
                (
                    "level",
                    models.CharField(
                ...
                (
                    "is_primary",
                    models.BooleanField(
                        default=False, verbose_name="Spécialité principale"
                    ),
                ),
                (
                    "created_by",
        ...
        migrations.AddIndex(
            model_name="teacher",
            index=models.Index(
                fields=["teacher_id"], name="teachers_te_teacher_5d8d41_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="teacher",
