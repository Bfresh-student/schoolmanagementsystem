...
class UserListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'full_name', 'role', 'status', 'is_active', 'date_joined']
...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_teacher', 'is_student', 'profile', 'date_joined', 'last_login'
        ]
...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # (voir apps/users/signals.py) — pas besoin de le créer ici.
        return user
