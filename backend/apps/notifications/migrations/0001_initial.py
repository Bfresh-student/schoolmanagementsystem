    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_address', models.CharField(help_text='Email, numéro de téléphone, ou device token', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_template', models.TextField(help_text="Utilise la syntaxe {variable} pour l'interpolation")),
                ('variables', models.JSONField(blank=True, default=list, help_text='Liste des variables attendues')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_key', models.CharField(max_length=100)),
                ('default_priority', models.CharField(choices=[('low', 'Basse'), ('normal', 'Normale'), ('high', 'Haute'), ('urgent', 'Urgente')], default='normal', max_length=10)),
            ],
            options={
